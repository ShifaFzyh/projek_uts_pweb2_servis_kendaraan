...
<script>
   ...
   gtag("config", "G-M8S4MT3EYG");
		...
		<title>Landing Page - GoMontir</title>
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						...
						<ul class="navbar-nav ms-auto me-lg-3">
							...
							<li class="nav-item">
								<a class="nav-link" href="https://codescandy.com/">Support</a>
							</li>
						</ul>
					...
					<div class="row">
						<div class="col-lg-6 offset-lg-3 col-md-12 col-12">
							<div class="text-center mb-8">
								<a href="#LayananKami" class="btn btn-primary">Layanan Kami</a>
								<h2 id="LayananKami" class="mb-0 mt-4">Layanan Kami</h2>
						</div>
					</div>
					...
					<div class="row gy-5">
						<div class="col-md-6">
							<div class="d-flex flex-column gap-4">
								...
								<div>
									<h3 class="h4">Great work fast and responsive.</h3>
									<p class="mb-0">
										Cepat dan Responsif!
...
Saya bingung soal kerusakan motor, tapi CS GoMontir langsung bantu arahkan dan beri solusi tepat. Mantap!.</p>
								<a href="#" class="btn btn-primary rounded-pill">Book Services</a>
							</div>
						</div>
					</div>
				</div>
